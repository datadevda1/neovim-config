...
-- noice keymaps
keymap.set("n", "<leader>nd", "<cmd>NoiceDismiss<CR>", { desc = "Dismiss Noice messages" }) -- dismiss Noice mesasges

-- markview keymaps
keymap.set("n", "<leader>rmt", "<cmd>RenderMarkdown toggle<CR>", { desc = "Toggles Markdown Preview" }) -- toggle RenderMarkdown for markdown files
